...
void commandeW::on_NUM_clicked()
{
   ui->view->setModel(C.afficherCommande(1));
}
   void commandeW::on_PAIMENT_clicked()
   {
      ui->view->setModel(C.afficherCommande(2));
   }
      void commandeW::on_ID_clicked()
      {
         ui->view->setModel(C.afficherCommande(3));
      }
void commandeW::on_valider_clicked()
{
    Livraison L(nullptr);
...
void commandeW::on_pb_supprimer_clicked()
{
    Commande C1;
...
void commandeW::on_cherchermodif_clicked()
{
    Commande C1;
...
void commandeW::on_valider_3_clicked()
{
...
void commandeW::on_pushButton_clicked()
{
