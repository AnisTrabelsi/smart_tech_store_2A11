...
void Categoriew::on_NUM_clicked()
{
   ui->view->setModel(CA.afficherCategorie(1));
}
   void Categoriew::on_PAIMENT_clicked()
   {
      ui->view->setModel(CA.afficherCategorie(2));
   }
      void Categoriew::on_ID_clicked()
      {
...
void Categoriew::on_pb_supprimer_clicked()
{
    Categorie C1;
...
void Categoriew::on_cherchermodif_clicked()
{
    Categorie C1;
...
void Categoriew::on_valider_3_clicked()
{
