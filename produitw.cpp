...
void produitw::on_pb_ajouter_clicked()
...
void produitw::on_pb_supprimer_clicked()
{
    Produit P1;
...
void produitw::on_pb_chercher_clicked()
{
    Produit P1;
...
void produitw::on_pb_modifier_clicked()
{
...
void produitw::on_cherche_aff_clicked()
{
    Produit P;
...
void produitw::on_tri_croissant_clicked()
{Produit P;
    ui->tab_produit->setModel(P.tri_croissant());
}

void produitw::on_tri_decroissant_clicked()
{
    Produit P;
...
void produitw::on_tri_ref_clicked()
{    ui->tab_produit->setModel(P.tri_ref());

}

void produitw::on_tri_quantite_clicked()
{
    ui->tab_produit->setModel(P.tri_quantite());
}

void produitw::on_tri_libelle_clicked()
{
    ui->tab_produit->setModel(P.tri_libelle());

}

void produitw::on_stat_clicked()
...
void produitw::on_reset_ajouter_clicked()
{
...
void produitw::on_export_but_clicked()
{
...
//////////////promotion///////////////
void produitw::on_pb_ajouterp_clicked()
...
void produitw::on_reset_ajouter_p_clicked()
{    ui->le_idp->clear();
     ui->le_idc->clear();
      ui->le_Pour->clear();
       ui->la_dated->clear();
...
void produitw::on_pb_supprimerp_clicked()
{
    Promotion P1,P2;
    Produit P;
...
void produitw::on_pb_chercher_p_clicked()
{Promotion P1;
...
void produitw::on_pb_modifiepr_clicked()
{
...
void produitw::on_cherche_affp_clicked()
{ Promotion P1;
...
void produitw::mailSent(QString status)
...
/////////////////////chat///////////////////////
void produitw::on_envoyer_clicked()
{ QTextStream T(mSocket);
...
void produitw::on_connecter_clicked()
{
...
void produitw::on_export_but_pour_clicked()
{QString fileName = QFileDialog::getSaveFileName(this, tr("Excel file"), qApp->applicationDirPath (),
...
void produitw::on_upload_clicked()
{
...
////////////////////////////////////////////////
void produitw::on_pb_ajouter_achat_clicked()
{bool test=false;
...
void produitw::on_cherche_aff_achat_clicked()
{Panier P2;
...
void produitw::on_pb_supprimer_achat_clicked()
{Panier P2,P3;
...
void produitw::on_pb_chercher_2_clicked()
{Panier P2;
...
void produitw::on_pb_modifier_achat_clicked()
...
void produitw::on_return_2_clicked()
{
    menu h(nullptr);
